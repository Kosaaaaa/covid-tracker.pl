      ...
      <div className="about__container">
        <Card className="about__card">
          ...
          <CardContent>
            ...
            <Typography className="about__typo">Strona ma również sekcję informacyjną w której można się dowiedzieć więcej na temat koronawirusa i jak sobie z nim radzić. Mozna się tam równiez dowiedzieć o tym jak dbać o swoje zdrowie psychiczne oraz innych.</Typography>
